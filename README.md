...
[split(str, separator)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/split)   | Divides `str` string into an ordered list of substrings by searching for `separator` pattern, puts these substrings into an array, and returns the array.
